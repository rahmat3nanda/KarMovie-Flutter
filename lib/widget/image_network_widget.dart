/*
 * *
 *  * image_network_widget.dart - KarMovie
 *  * Created by Rahmat Trinanda (rahmat3nanda@gmail.com) on 08/23/2024, 05:42
...
import 'package:kar_movie/page/image_viewer_page.dart';
...
class _ImageNetworkWidgetState extends State<ImageNetworkWidget> {
  ...
  Widget _mainView() {
    return CachedNetworkImage(
      ...
      placeholder: (c, url) =>
          _imageView(AssetImage(widget.defaultImage ?? AppImage.karMovieFill)),
      errorWidget: (c, url, e) =>
          _imageView(AssetImage(widget.defaultImage ?? AppImage.karMovieFill)),
    );
  }
